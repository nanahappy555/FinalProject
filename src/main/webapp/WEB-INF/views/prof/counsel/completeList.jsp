...
<div class="row">
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr style="cursor:pointer;" onclick="OpenWindow('<%=request.getContextPath()%>/prof/counsel/complete/detail','글등록',800,550);">
										<td scope="col">1001</td>
										<td scope="col">220102001</td>
										<td scope="col">박건영</td>
										<td scope="col">2022-09-30 10:00</td>
										<td scope="col">401호</td>
										<td scope="col">작성완료</td>
									</tr>
									<tr>
										<td scope="col">1001</td>
										<td scope="col">220102001</td>
