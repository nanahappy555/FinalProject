  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" data-rno>
		...
		<option value='counselWid' data-li='counselWidget'onclick="f_editStart()">지도학생관리(4x2)</option>
		<option value='assignWid' data-li='assignWidget'onclick="f_editStart()">과제제출현황(3x2)</option>
		</select>
      </div>
