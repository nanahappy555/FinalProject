...
<!-- ================================================= -->
<!-- 사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X -->
<!-- 사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X -->
<!-- 사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X -->
<!-- 사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X -->
<!-- 사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X사용X -->
...
<div class="card">
	...
	<div class="card-body">
		...
		<div class="row justify-content-end mt-2 mr-2">
		   <button class="btn btn-outline-primary" type="button"onclick="pageMove('<%=request.getContextPath()%>/prof/lec/assignment/regist');">과제등록</button>
		</div>
		<!-- ================================================= -->
		<!-- 등록 버튼 끝 -->
		<!-- ================================================= -->
...
var url = "<%=request.getContextPath()%>/prof/lec/assignment/detail";
