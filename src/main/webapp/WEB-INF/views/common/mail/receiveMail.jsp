...
<c:set var="receiveList" value="${dataMap.receiveList}"></c:set>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="email-title">
									<span class="icon"><i class="fas fa-inbox"></i></span> 받은 쪽지함 <span
										class="new-messages">( ${count }개의 새로운 메세지가 있습니다. )</span>
								</div>
							</div>
							<div class="col-lg-6">
							...
							<!-- 체크박스 -->
								<div class="email-list-actions">
									<label class="custom-control custom-checkbox"> <input
										...
										id="one" name='chk' value="${receive.noteSeq }"><span class="custom-control-label"></span>
								...
								<div class="email-list-detail" id="click" onclick="pageMove('<%=request.getContextPath()%>/common/mail/detail?noteSeq=${receive.noteSeq }')">
									<span class="date float-right"><fmt:formatDate value="${receive.sendDate }" pattern="yyyy년 MM월 dd일 hh:mm:ss"/></span>
...
/* 	var paramss = {
	...
	$.ajax({
		method:'post',
		url:"<%=request.getContextPath()%>/common/receive/moveBin",
...
<script>
	function list_go(page,url){
		if(!url) url="${webPath}/common/mail/received/list";
		var jobForm=$('#jobForm');
