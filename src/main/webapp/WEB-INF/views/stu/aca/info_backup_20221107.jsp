		                ...
		                <div class="user-avatar-info">
		                    ...
		                    <div class="user-avatar-address">
		                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
										<div class="card">
											<h4 class="card-header"><i class="fas fa-clipboard"></i>&nbsp;&nbsp;기본 정보</h4>
										<div class="card-body">
											...
											<div class="row justify-content-end">
												...
												<button type="button" class="btn btn-secondary mr-5" onclick="OpenWindow('<%=request.getContextPath()%>/stu/aca/info/modifyForm.do','글쓰기',500,800);" >수정하기</button>
											</div>
											</div>
										</div>
									</div>
						...
						<table class="table table-hover">
						    ...
						    <tbody>
						        <tr>
						            ...
						            <td>
						            	<div class="row justify-content-end">
											<button type="button" class="btn btn-secondary mr-5" onclick="OpenWindow('<%=request.getContextPath()%>/stu/aca/info/account/modifyForm','글쓰기',500,800);" >수정하기</button>
										</div>
						            </td>
						        </tr>
