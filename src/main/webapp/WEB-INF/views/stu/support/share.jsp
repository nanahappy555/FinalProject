...
function f_move(e){
	var currentTap = top.document.querySelector('#currentTap');
	var dataCd = e.target.parentElement.getAttribute("name"); // All or Lec
	var hiddenshaBno = e.target.parentElement.children[0].children[0].innerHTML;
	console.log(e.target.parentElement.children[0].children[0].innerHTML);
