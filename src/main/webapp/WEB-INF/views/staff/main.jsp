  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" data-rno>
		...
		<option value='tuitionWid' data-li='tuitionWidget'onclick="f_editStart()">등록금납부현황(3x3)</option>
		<option value='qnaWid' data-li='qnaWidget'onclick="f_editStart()">QNA답변현황(2x2)</option>
		</select>
      </div>
